...
ActiveRecord::Schema.define(version: 20141125073032) do
  ...
  create_table "metric_interestrate_irswap_fixedfloat", id: false, force: true do |t|
    t.integer "dissemination_id",                                   limit: 8,   null: false
    ...
    t.string  "spread_delta",                                       limit: nil
    t.string  "fixed_delta",                                        limit: nil
  end

  create_table "metric_interestrate_irswap_fixedfloats", force: true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "metric_interestrate_irswap_ois", id: false, force: true do |t|
    t.integer "dissemination_id",                                   limit: 8,   null: false
    t.string  "original_dissemination_id",                          limit: nil
    t.string  "action",                                             limit: nil
    t.integer "execution_timestamp",                                limit: 8
